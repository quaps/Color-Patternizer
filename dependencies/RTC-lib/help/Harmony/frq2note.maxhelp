...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.0, 246.0, 84.0, 24.0 ],
					"prototypename" : "bubble",
					"style" : "",
					"text" : "note name"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 229.5, 218.0, 69.0, 24.0 ],
					"style" : "",
					"text" : "+ Cents"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 82.0, 218.0, 95.0, 24.0 ],
					"style" : "",
					"text" : "note number"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 104.0, 128.0, 106.0, 24.0 ],
					"style" : "",
					"text" : "frequency (Hz)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 102.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "lb 440"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 42.0, 128.0, 56.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 42.0, 157.0, 55.0, 22.0 ],
					"style" : "",
					"text" : "frq2note"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 42.0, 246.0, 37.0, 22.0 ],
					"prototypename" : "float",
					"style" : "",
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 191.0, 218.0, 37.0, 22.0 ],
					"style" : "",
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 42.0, 217.0, 37.0, 22.0 ],
					"style" : "",
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 42.0, 186.0, 168.0, 22.0 ],
					"style" : "",
					"text" : "note2cents"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 124.0, 74.0, 56.0, 20.0 ],
					"style" : "",
					"text" : "intv2ratio",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 184.0, 74.0, 63.0, 20.0 ],
					"style" : "",
					"text" : "note2cents",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 74.0, 56.0, 20.0 ],
					"style" : "",
					"text" : "ratio2intv",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 252.0, 74.0, 50.0, 20.0 ],
					"style" : "",
					"text" : "note2frq",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 1.0, 84.0, 22.0 ],
					"style" : "",
					"text" : "frq2note",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
