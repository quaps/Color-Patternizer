...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 5,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 272.0, 89.0, 22.0 ],
					"style" : "",
					"text" : "play 127 500 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 37.0, 211.0, 69.0, 22.0 ],
					"style" : "",
					"text" : "anti-octave"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 37.0, 138.0, 294.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 89.0, 242.0, 67.0, 20.0 ],
					"style" : "",
					"text" : "note name"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 128.0, 211.0, 223.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 88.0, 67.0, 20.0 ],
					"style" : "",
					"text" : "anti-interval",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 236.0, 88.0, 79.0, 20.0 ],
					"style" : "",
					"text" : "check-octaves",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 88.0, 98.0, 20.0 ],
					"style" : "",
