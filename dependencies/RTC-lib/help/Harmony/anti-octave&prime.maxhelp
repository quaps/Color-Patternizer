...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 5,
					"numoutlets" : 0,
					"patching_rect" : [ 37.0, 286.0, 89.0, 22.0 ],
					"style" : "",
					"text" : "play 127 500 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 37.0, 225.0, 143.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 37.0, 153.0, 294.0, 60.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 37.0, 255.0, 39.0, 22.0 ],
					"prototypename" : "float",
					"style" : "",
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 256.0, 68.0, 20.0 ],
					"style" : "",
					"text" : "note name"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 188.5, 249.5, 188.0, 33.0 ],
					"style" : "",
					"text" : "flashes when an octave or prime would have occured"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 131.0, 102.0, 67.0, 20.0 ],
					"style" : "",
					"text" : "anti-interval",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 202.0, 102.0, 79.0, 20.0 ],
					"style" : "",
					"text" : "check-octaves",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 64.0, 102.0, 63.0, 20.0 ],
					"style" : "",
					"text" : "anti-octave",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 0.0, 51.0, 414.0, 47.0 ],
					"style" : "",
