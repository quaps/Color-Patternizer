...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 175.0, 157.0, 33.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 162.0, 129.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "lb 250"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 110.0, 128.0, 50.0, 22.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 57.0, 266.0, 23.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 57.0, 196.0, 137.0, 22.0 ],
					"style" : "",
					"text" : "random 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 57.0, 157.0, 72.0, 22.0 ],
					"style" : "",
					"text" : "metro 250"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 57.0, 227.0, 70.0, 22.0 ],
					"style" : "",
					"text" : "anti-bis"
				}
...
,
					"patching_rect" : [ 57.0, 296.0, 60.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 115.0, 88.0, 71.0, 20.0 ],
					"style" : "",
					"text" : "anti-bis&osc",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 63.0, 88.0, 49.0, 20.0 ],
					"style" : "",
					"text" : "anti-osc",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1.0, 1.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "anti-bis",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
