...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 262.5, 196.0, 56.0, 20.0 ],
					"style" : "",
					"text" : "permutate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 218.0, 196.0, 35.0, 20.0 ],
					"style" : "",
					"text" : "sneak"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 173.0, 196.0, 40.0, 20.0 ],
					"style" : "",
					"text" : "rota"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 40.0, 107.0, 36.0, 20.0 ],
					"style" : "",
					"text" : "int #1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 40.0, 135.0, 23.0, 20.0 ],
					"style" : "",
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 40.0, 196.0, 36.0, 20.0 ],
					"style" : "",
					"text" : "alea"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 40.0, 161.0, 241.5, 20.0 ],
					"style" : "",
					"text" : "gate 6"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "int" ],
					"patching_rect" : [ 120.0, 196.0, 51.0, 20.0 ],
					"style" : "",
					"text" : "sequence"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "bang", "int" ],
					"patching_rect" : [ 80.0, 196.0, 36.0, 20.0 ],
					"style" : "",
					"text" : "series"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 26.0, 65.0, 32.5, 20.0 ],
					"style" : "",
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 254.0, 140.0, 18.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 39.0, 272.0, 38.0, 18.0 ],
					"style" : "",
					"text" : "vs.5.0"
				}
