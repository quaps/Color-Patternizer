{
	"patcher" : 	{
		...
		"boxes" : [ 			{
				"box" : 				{
					"maxclass" : "inlet",
					"patching_rect" : [ 173.0, 32.0, 15.0, 15.0 ],
					"numinlets" : 0,
					"numoutlets" : 1,
					"id" : "obj-1",
					"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "int",
					"patching_rect" : [ 173.0, 89.0, 27.0, 19.0 ],
					"fontsize" : 9.0,
					"numinlets" : 2,
					"numoutlets" : 1,
					"id" : "obj-3",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "slice",
					"patching_rect" : [ 69.0, 122.0, 123.0, 19.0 ],
					"fontsize" : 9.0,
					"numinlets" : 2,
					"numoutlets" : 2,
					"id" : "obj-5",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "join",
					"patching_rect" : [ 69.0, 220.0, 123.0, 19.0 ],
					"fontsize" : 9.0,
					"numinlets" : 2,
					"numoutlets" : 1,
					"id" : "obj-8",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "p exceptions",
					"patching_rect" : [ 123.0, 250.0, 73.0, 19.0 ],
					"fontsize" : 9.0,
					"numinlets" : 1,
					"numoutlets" : 2,
					"id" : "obj-9",
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "butlast",
									"patching_rect" : [ 78.0, 64.0, 39.0, 19.0 ],
									"fontsize" : 9.0,
									"numinlets" : 1,
									"numoutlets" : 1,
									"id" : "obj-4",
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "butfirst",
									"patching_rect" : [ 29.0, 63.0, 43.0, 19.0 ],
									"fontsize" : 9.0,
									"numinlets" : 1,
									"numoutlets" : 1,
									"id" : "obj-5",
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"text" : "switch 3",
					"patching_rect" : [ 15.0, 280.0, 181.0, 19.0 ],
					"fontsize" : 9.0,
					"numinlets" : 4,
					"numoutlets" : 1,
					"id" : "obj-10",
