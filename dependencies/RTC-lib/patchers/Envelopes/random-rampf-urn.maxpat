{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 191.0, 281.0, 464.0, 373.0 ],
		"bglocked" : 0,
		"defrect" : [ 191.0, 281.0, 464.0, 373.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 130.0, 176.0, 48.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"bgcolor" : [ 0.866667, 0.866667, 0.866667, 1.0 ],
					"outlettype" : [ "float", "bang" ],
					"patching_rect" : [ 199.0, 176.0, 48.0, 17.0 ],
					"htextcolor" : [ 0.870588, 0.870588, 0.870588, 1.0 ],
					"id" : "obj-2"
				}
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 34.0, 130.0, 573.0, 246.0 ],
						"bglocked" : 0,
						"defrect" : [ 34.0, 130.0, 573.0, 246.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
						...
						"boxes" : [ 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "p anti-bis-float",
									"fontname" : "Arial",
									"numinlets" : 1,
									"numoutlets" : 2,
									"fontsize" : 9.0,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 303.0, 146.0, 79.0, 17.0 ],
									"id" : "obj-1",
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 10.0, 59.0, 383.0, 265.0 ],
										"bglocked" : 0,
										"defrect" : [ 10.0, 59.0, 383.0, 265.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 12.0,
										"default_fontface" : 0,
										...
										"boxes" : [ 											{
												"box" : 												{
													"maxclass" : "newobj",
													"text" : "if ($f1!=$f2) then $i1 else out2 bang",
													"fontname" : "Arial",
													"numinlets" : 2,
													"numoutlets" : 2,
													"fontsize" : 9.0,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 50.0, 76.0, 176.0, 17.0 ],
													"id" : "obj-1"
												}
...
, 											{
												"box" : 												{
													...
													"fontsize" : 9.0,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 216.0, 50.0, 31.0, 17.0 ],
													"id" : "obj-2"
												}
...
, 											{
												"patchline" : 												{
													...
													"destination" : [ "obj-2", 0 ],
													"hidden" : 0,
													"midpoints" : [ 59.5, 101.0, 39.0, 101.0, 39.0, 41.0, 225.5, 41.0 ]
												}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 9.0,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 43.0, 145.0, 79.0, 17.0 ],
									"id" : "obj-2",
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 10.0, 59.0, 355.0, 249.0 ],
										"bglocked" : 0,
										"defrect" : [ 10.0, 59.0, 355.0, 249.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 12.0,
										"default_fontface" : 0,
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 215.0, 98.0, 15.0, 15.0 ],
													"id" : "obj-5",
													"comment" : ""
												}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "between-lin-urn #1 #2 #3",
									"fontname" : "Arial",
									"numinlets" : 4,
									"numoutlets" : 2,
									"fontsize" : 9.0,
									"outlettype" : [ "", "int" ],
									"patching_rect" : [ 43.0, 121.0, 205.0, 17.0 ],
									"id" : "obj-3"
								}
...
, 							{
								"box" : 								{
									"maxclass" : "newobj",
									"text" : "between-log-urn #4 #5 #6",
									"fontname" : "Arial",
									"numinlets" : 4,
									"numoutlets" : 2,
									"fontsize" : 9.0,
									"outlettype" : [ "float", "int" ],
									"patching_rect" : [ 303.0, 121.0, 229.0, 17.0 ],
									"id" : "obj-8"
								}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 31.0, 242.0, 118.0, 17.0 ],
					"id" : "obj-18"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 31.0, 294.0, 15.0, 15.0 ],
					"id" : "obj-19",
					"comment" : "velocity"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 130.0, 209.0, 156.0, 17.0 ],
					"id" : "obj-20"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 31.0, 117.0, 84.0, 17.0 ],
					"id" : "obj-24"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 196.0, 284.0, 141.0, 17.0 ],
					"id" : "obj-26"
				}
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "float version of random-ramp-urn",
					"fontname" : "Arial",
					"numinlets" : 1,
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 196.0, 300.0, 164.0, 17.0 ],
					"id" : "obj-27"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"fontsize" : 9.0,
					"patching_rect" : [ 52.0, 295.0, 100.0, 17.0 ],
					"id" : "obj-28"
				}
